...
(function () {
  ...
  function Logo({ size = 38, light = true, stacked = false, onClick, style = {} }) {
    ...
    const word = h('div', { style: { lineHeight: 1.1, display: stacked ? 'block' : 'flex', flexDirection: 'column' } },
      h('div', { style: { fontFamily: 'var(--serif)', fontWeight: 600, fontSize: size * .42, letterSpacing: '.02em', color: light ? 'var(--cream)' : '#1a120a' } }, 'Namaste MoMo & curry house'),
    );
