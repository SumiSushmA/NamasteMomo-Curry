...
<div class="cust-page-head cust-pad">
    <div class="eyebrow center" style="justify-content:center;margin-bottom:16px">{{ \App\Support\SiteContent::text('Gallery eyebrow', 'Gallery') }}</div>
    <h1 style="font-size:clamp(38px,5vw,62px);line-height:1.03">{{ \App\Support\SiteContent::text('Gallery title', 'A look inside') }}</h1>
