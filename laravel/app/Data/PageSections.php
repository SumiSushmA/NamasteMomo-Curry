    ...
    public static function grouped(): array
    {
        return [
            ...
            'Homepage' => [
                ...
                ['section' => 'Home tandoor eyebrow', 'type' => 'Text', 'label' => 'Tandoor band eyebrow', 'default' => 'Clay oven'],
                ['section' => 'Home tandoori title', 'type' => 'Text', 'label' => 'Tandoor band heading', 'default' => 'Fresh naan from the tandoor'],
                ['section' => 'Home tandoor text', 'type' => 'Textarea', 'label' => 'Tandoor band body', 'default' => 'Garlic naan, butter naan, and tandoor-roasted favorites — baked at high heat until soft inside and lightly charred outside.'],
                ['section' => 'Home tandoor tags', 'type' => 'Textarea', 'label' => 'Tandoor tags (one per line)', 'default' => "Yogurt-marinated\nHigh-heat roasted\nServed with chutney"],
