...
(function () {
  ...
  function Settings() {
    ...
    return h('div', { style: { maxWidth: 760 } },
      ...
      block('Restaurant profile', [{ label: 'Name', sub: 'Shown across the site', value: 'Namaste MoMo & curry house' }, { label: 'Address', sub: 'Primary location', value: '418 Saffron Lane' }, { label: 'Hours', sub: 'Service window', value: 'Tue–Sun · 11:30–22:00' }]),
