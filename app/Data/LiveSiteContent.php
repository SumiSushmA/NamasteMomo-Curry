...
class LiveSiteContent
{
    ...
    public static function contentBlocks(): array
    {
        return [
            ...
            'Home momo title' => 'Our famous momo menu',
            'Home momo text' => 'Steamed, fried, jhol, sandheko, chili, butter masala & tandoori — including our four-style Combo Momo Feast.',
            'Home tandoori title' => 'From the tandoor clay oven',
            'Home curry title' => 'Curries & homestyle plates',
            'Home signatures title' => 'Guest favorites',
            'Home delivery title' => 'Delivery & pickup',
            'Home reserve title' => 'Dine in with us',
            'Home reserve text' => 'Walk in or reserve a table in our welcoming dining room — friendly service, cozy booths, and the aroma of momo and masala in the air.',
            'Home catering title' => 'Feed your crowd',
            'Home gallery eyebrow' => 'Inside the restaurant',
            'Home gallery title' => 'The food, the room & the feast',
            'Home reviews eyebrow' => 'From our guests',
            'Home reviews title' => 'Why neighbors keep coming back',
            'Home footer headline' => 'Craving momo tonight? We\'ve got you.',
            'Delivery blurb' => 'Order from Namaste MoMo & curry house for pickup or delivery. Most orders are ready in 30–60 minutes within our local delivery area.',
            'Catering blurb' => 'From office lunches to birthdays and celebrations — Namaste MoMo & curry house caters groups of 20 and up with momo trays, curries, biryani, and naan.',
        ];
    }
    ...
    public static function about(): array
    {
        return [
            'story' => [
                'Namaste MoMo & curry house is a family-run restaurant on Aurora Avenue — a warm, welcoming spot where momo leads the menu and curry house classics fill the table.',
                'From steamed and jhol momo to tandoori platters, biryanis, Nepali thali, and vegetarian specialties, we cook every plate to order with authentic spice and generous portions.',
                'Whether you dine in, pick up, or order delivery, expect the kind of hospitality that makes you feel at home — namaste, and welcome to our table.',
            ],
            'values' => [
                ['icon' => 'flame', 'title' => 'Made to order', 'text' => 'Every momo basket and curry is fired fresh when you order — never sitting under a heat lamp.'],
                ['icon' => 'leaf', 'title' => 'Momo & curry roots', 'text' => 'Recipes from the Himalayan hills and Indian kitchen, with vegetarian and vegan options across the menu.'],
                ['icon' => 'users', 'title' => 'Family welcome', 'text' => 'Counter service, cozy dining room, and the warm greeting that keeps Aurora neighbors coming back.'],
            ],
            'stats' => [
    ...
    {
        return [
            ['name' => 'Sarah M.', 'stars' => 5, 'text' => 'Namaste MoMo & curry house has the best jhol momo in the area. The combo platter is a must — we order it every visit.', 'tag' => 'Google'],
            ['name' => 'James T.', 'stars' => 5, 'text' => 'Warm service, big portions, and curries that taste like home. Our go-to momo and curry spot on Aurora Avenue.', 'tag' => 'Yelp'],
            ['name' => 'Priya K.', 'stars' => 5, 'text' => 'The tandoori momo and garlic naan are incredible. So happy Namaste MoMo & curry house is in the neighborhood.', 'tag' => 'Google'],
            ['name' => 'Michael R.', 'stars' => 5, 'text' => 'Reliable delivery, food arrives hot, and the butter lamb curry is outstanding. Highly recommend for family dinners.', 'tag' => 'Google'],
            ['name' => 'Anita S.', 'stars' => 5, 'text' => 'Cozy dining room and staff who remember your order. The chili momo and mango lassi are my favorites.', 'tag' => 'Regular guest'],
            ['name' => 'David L.', 'stars' => 5, 'text' => 'Catered our office lunch — trays of momo and biryani disappeared in minutes. Professional and delicious.', 'tag' => 'Catering'],
        ];
    }
