...
class SeedData
{
    ...
    public static function about(): array
    {
        return [
            'story' => [
                'Namaste MoMo & curry house began with two cooks and one stubborn idea: that the food of the subcontinent and the food of the Himalayan hills belong at the same table.',
    ...
    {
        return [
            ['name' => 'Admin', 'role' => 'Owner', 'email' => 'indainnepaliadmin@kitchen.com', 'status' => 'Active', 'last' => '2m ago'],
        ];
    }
