...
class GiftCardController extends Controller
{
    public function index(): View
    {
        ...
        $occasions = GiftCardOccasion::query()->orderBy('sort_order')->orderBy('name')->get();
    ...
    public function updateOccasion(Request $request, GiftCardOccasion $occasion): RedirectResponse
    {
        $data = $request->validate([
            'name' => 'required|string|max:80',
        ...
        return back()->with('success', 'Gift card occasion updated.');
    }
}
